...
############################################################################################################
upper_boundary = [boundary_vertices[i] for i in range(len_h+1)]
lower_boundary = [boundary_vertices[i] for i in range(len_h+len_v, 2*len_h+len_v+1)]
...
# for i in range(60,64):
    ...
    # plot the codeword
    ax.scatter(xs[pos_ones], ys[pos_ones], marker='o', s=150, color='green', zorder=1)
